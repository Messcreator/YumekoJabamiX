...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @IzumiBotOfficial \
...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *𝑬𝒎𝒊𝒍𝒊𝒂*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ _Emilia is licensed under the GNU General Public License v3.0_
                 ).
                 \n\nIf you have any question about Emilia, let us know.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Emilia*
                 \nHere is the [Source Code](https://github.com/IzumiCypherX/Emilia2.0) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Emilia Is Up Again [😀](https://telegra.ph/file/4e87c85b6bbae331dd78f.jpg), parse_mode=ParseMode.MARKDOWN")
        except Unauthorized:
            LOGGER.warning(
